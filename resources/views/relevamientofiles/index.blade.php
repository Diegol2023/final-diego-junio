...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav" style="background-color: #4fe9e1;">
                    <li class="nav-item">
                       <a href="{{url('index')}}" class="nav-link " aria-current="page" href="#">INICIO</a>
                    </li>
                    <li class="nav-item">
                       <a  href="{{url('create')}}" class="nav-link " href="#">CREAR</a>
                    </li> 
                    {{-- <li class="nav-item"> 
                       <a  href="{{url('editar')}}" class="nav-link" href="#">EDITAR</a> 
                    </li> 
                    <li class="nav-item"> 
        ...
        <table class="table table-bordered">
            {{-- <p style="font-size: x-large">RELEVAMIENTO...</p> --}}
            <div style="background-color: #9da1a1cc;"><h1><center>LISTADO DEL RELEVAMIENTO</center></h1></div>
            ...
            <thead>
              <tr>
                ...
                <th scope="col">Telefono Interno</th>
              </tr>
            ...
            <tr>
                ...
                <td>{{$relevamientos->telinterno}}</td>
                <td>
        ...
        <nav class="navbar" style="background-color: #4fe9e1;">
            <!-- Navbar content -->
        </nav>
    ...
    {{-- <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <table class="table table-bordered">
            <p style="font-size: x-large">RELEVAMIENTO...</p>
            <h1>LISTADO DEL RELEVAMIENTO</h1>
